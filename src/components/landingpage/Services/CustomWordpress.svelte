    ...
    <div class="col-md-8">
        <div class="container">
            ...
            <div>
                ...
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#customWordpress">Learn More</button>

                <!-- The Modal -->
                <div class="modal fade" id="customWordpress">
                    <div class="modal-dialog">
                        <div class="modal-content text-dark">
                            <!-- Modal Header -->
                            <div class="modal-header">
                                <h4 class="modal-title"><strong><i class="fa-brands fa-wordpress"></i> Custom Web Design with WordPress</strong></h4>
                                <button type="button" class="close" data-dismiss="modal">&times;</button>
                            </div>
                    
                            <!-- Modal body -->
                            <div class="modal-body">
                                <p>At Neospaces, we're passionate about creating exceptional online experiences, and WordPress is our canvas of choice. With its unparalleled versatility, we craft custom websites that not only look stunning but also perform flawlessly.</p>
