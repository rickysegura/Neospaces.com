    ...
    <div class="col-md-8">
        <div class="container">
            ...
            <div>
                ...
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#webMaint">Learn More</button>
                
                <!-- The Modal -->
                <div class="modal fade" id="webMaint">
                    <div class="modal-dialog">
                        <div class="modal-content text-dark">
                            <!-- Modal Header -->
                            <div class="modal-header">
                                <h4 class="modal-title"><strong><i class="fa-solid fa-shield-halved"></i> Website Management and Maintenance</strong></h4>
                                <button type="button" class="close" data-dismiss="modal">&times;</button>
                            </div>
                    
                            <!-- Modal body -->
                            <div class="modal-body">
                                <p>Your website is the digital face of your business. At Neospaces, we understand the importance of keeping it running smoothly, securely, and up-to-date. Our Website Management and Maintenance service ensures your online presence remains a powerful asset.</p>
